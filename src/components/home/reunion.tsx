    ...
    <div className="flex flex-col justify-center items-center min-h-screen bg-black space-y-8 py-8 px-4">
      ...
      >
        <CardHeader className="w-full md:w-1/2 text-left">
          <h2 className="text-2xl sm:text-3xl mb-4 tracking-wide">Você pode personalizar o plano que mais se adeque ao seu momento</h2 >
      ...
      <Link
        href='#contact'
        className='mt-8 block text-white bg-[rgb(22,156,18)] border-0 text-[16px] lg:text-[20px] text-center
-rounded-lg cursor-pointer px-4 lg
py-3 w-full lg
