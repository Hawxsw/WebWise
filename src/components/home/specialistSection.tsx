  ...
  return (
    <section className="bg-[rgb(38,38,38)] p-5 text-white flex flex-col lg:flex-row items-center gap-5">
      <div className="lg:w-1/2 flex flex-col items-center text-center">
        ...
        <Link
          href='#contact'
          className='mt-8 block text-white bg-[rgb(22,156,18)] border-0 text-[16px] lg:text-[20px] rounded-lg cursor-pointer px-4 lg:px-6 py-3 w-full lg:w-auto max-w-[300px] mx-auto'
